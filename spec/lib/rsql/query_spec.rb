  ...
  RSpec.describe Query do
    ...
    describe 'execute' do
      ...
      it 'returns query' do
        ...
        result = Query.execute('select * from books')[0]
      ...
      describe 'select' do
        ...
        example '1 record' do
          result = Query.execute('select * from books where id = 1')[0]
          expect(result[:columns]).to eq Book.attribute_names
      ...
      example 'syntax error' do
        result = Query.execute('invalid sql')[0]
